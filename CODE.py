...
class Bill_App:
    ...
    def testing(
            self, m_t_p, m_m_p, m_ts_p, m_tb_p, m_pc_p, m_nb_p,
            d_jt_p, d_md_p, d_cc_p, d_s_p, d_f_p, d_mw_p,
            f_pc_p, f_hd_p, f_fnc_p, f_n_p, f_b_p, f_ff_p,
            m_tax, d_tax, f_tax
        ):
        
        total_merchandise_price=float(
            m_t_p + m_t_p+ m_m_p + m_ts_p + m_tb_p + m_pc_p + m_nb_p
        )
